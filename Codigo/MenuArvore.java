...
// CLASSE MENU DA ARVORE B+
public class MenuArvore{
    public static Scanner scanner = new Scanner(System.in);
    public static ArquivoArvore arquivo;
    static {
        try{
            arquivo = new ArquivoArvore("PilotosArvore", 4);
        } catch(Exception e){
            e.printStackTrace();
        }
    }
    ...
    // METODO MENU
    public static void menuArvoreBMais() throws Exception{
        int opcao = 50;
        ...
        while(opcao != 0){
           ...
           System.out.println("1 - Fazer Carga com Árvore B+");
           ...
           switch(opcao){
              ...
              case 1:
                  ...
                  System.out.print("\nDigite a ordem da Árvore B+: ");
                  int ordem = scanner.nextInt();
                  arquivo = new ArquivoArvore("PilotosArvore", ordem);
                  arquivo.criarArvore();
                  break;
              case 2:
                  adicionarPiloto();
